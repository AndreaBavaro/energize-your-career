        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 mb-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-stone-700 leading-relaxed font-medium italic text-center py-4 border-y border-alternative-300/80">
          ...
          <div className="md:hidden mb-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              <GlassCard className="p-4 text-center">
                <div className="rounded-full w-12 h-12 bg-alternative-100 flex items-center justify-center mx-auto mb-3">
                  <Award className="h-6 w-6 text-alternative-600" />
                </div>
              ...
              <GlassCard className="p-4 text-center">
                <div className="rounded-full w-12 h-12 bg-alternative-100 flex items-center justify-center mx-auto mb-3">
                  <Heart className="h-6 w-6 text-alternative-600" />
                </div>
          ...
          <div className="hidden md:grid grid-cols-3 gap-6 mb-10">
            ...
            <GlassCard className="p-6 text-center">
              <div className="rounded-full w-16 h-16 bg-alternative-100 flex items-center justify-center mx-auto mb-4">
                <Award className="h-8 w-8 text-alternative-600" />
              </div>
            ...
            <GlassCard className="p-6 text-center">
              <div className="rounded-full w-16 h-16 bg-alternative-100 flex items-center justify-center mx-auto mb-4">
                <Heart className="h-8 w-8 text-alternative-600" />
              </div>
          ...
          <div className="bg-alternative-50 rounded-2xl p-8 shadow-inner">
