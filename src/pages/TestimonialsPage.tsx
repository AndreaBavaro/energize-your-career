...
const TestimonialsPage = () => {
  ...
  const testimonials = [
    // CLIENT TESTIMONIALS
    {
      fullQuote: `IPC Systems and Ban Partners have been partners for over 15 years. Melinda and her team have been extremely helpful in providing Technical Project Managers and Field Engineers. Most recently, Melinda provided a contract-PM for us that we eventually hired as a direct employee and has been excelling in his work. Melinda is always responsive and thoughtful in her approach and can be counted upon to deliver highly qualified candidates at a reasonable market rate. I highly recommend Melinda, without any reservation.`,
      author: 'Tim Richards',
